defmodule AOC2022.TuningProblem do
  @moduledoc """
  ...
  marker in the datastream. In the protocol being used by the Elves, the start of a packet is indicated by a sequence
  ...
  def solve(input, marker_length: marker_length) do
    input
    |> String.trim()
    |> String.graphemes()
