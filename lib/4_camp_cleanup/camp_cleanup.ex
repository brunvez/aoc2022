defmodule AOC2022.CampCleanup do
  @moduledoc """
  --- Day 4: Camp Cleanup ---
  ...
  noticed that many of the assignments overlap. To try to quickly find overlaps and reduce duplicated effort,
  ...
  cleaning sections their partner will already be cleaning, so these seem like the most in need of reconsideration. In this example, there are 2 such pairs.
  ...
  def cointained?({{a, b}, {c, d}}) do
    (a <= c && b >= d) || (c <= a && d >= b)
  end

  def overlapping?({{a, b}, {c, d}}) do
